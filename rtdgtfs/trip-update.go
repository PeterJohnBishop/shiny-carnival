...
func GetTripUpdates(url string) ([]*gtfs.TripUpdate, error) {
	var allTripUpdates []*gtfs.TripUpdate
	...
	for _, entity := range feed.GetEntity() {
		if tripUpdate := entity.GetTripUpdate(); tripUpdate != nil {
			allTripUpdates = append(allTripUpdates, tripUpdate)
		}
	}

	return allTripUpdates, nil
}
